...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 -ml-48 -mt-48 w-96 h-96 rounded-full bg-blue-600/10 blur-3xl opacity-50"></div>
      <div className="absolute bottom-0 right-0 -mr-48 -mb-48 w-96 h-96 rounded-full bg-indigo-600/10 blur-3xl opacity-50"></div>
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 md:p-12 rounded-[2rem] shadow-2xl shadow-slate-200/50 border border-slate-100 relative z-10 mx-4">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-slate-500 text-sm font-medium">
            ...
            <Link href="/login" className="font-bold text-blue-600 hover:text-blue-700 underline underline-offset-4 decoration-blue-200 hover:decoration-blue-600 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
